	...
	NDefines.NAI.ROCKET_PRIORITIZE_BARRAGE = true			-- 红色黎明 蹦蹦炸弹！
	NDefines.NAI.ROCKET_MIN_ASSIGN_SCORE = 0 --10 红色黎明 到处乱射
	NDefines.NAI.ROCKET_MIN_PRIO_ASSIGN_SCORE = 0 --50 红色黎明 到处乱射
	...
	NDefines.NAir.COMBAT_BETTER_AGILITY_DAMAGE_REDUCTION = 0.85 -- 红色黎明NAir标记
	...
	NDefines.NAir.MISSILE_LAUNCHER_SLOTS = 1 --红色黎明标记 1导弹槽选择
	...
	NDefines.NBuildings.SAM_MISSION_SUPERIORITY = 20.0      -- 5 红色黎明NBuildings标记 #地空导弹的空中优势
